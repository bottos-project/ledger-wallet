#ifndef GLYPH_badge_ont_BPP
#define GLYPH_badge_ont_WIDTH 50
#define GLYPH_badge_ont_HEIGHT 50
#define GLYPH_badge_ont_BPP 4
extern
...
extern
const bagl_icon_details_t C_badge_ont;
#endif // GLYPH_badge_ont_BPP
